...
interface FlightMapProps {
  ...
  /** Recent position trail of the selected aircraft, as [lat, lon] pairs. */
  trail?: [number, number][];
...
function FlightMapInner({
  ...
  return (
    ...
    >
      ...
      {/* Actual flown trail of the selected aircraft (from flight_positions). */}
      {trail && trail.length > 1 && (
        <Polyline positions={trail} pathOptions={{ color: "#00d4ff", weight: 2, opacity: 0.8 }} />
      )}
